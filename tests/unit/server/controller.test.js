...
describe('#Controller - Test suite for controller calls', () => {
  ...
  describe('handleCommand', () => {
    test('Command stop', async () => {
      jest.spyOn(Service.prototype, Service.prototype.stopStreamming.name).mockResolvedValue()
    ...
    test('Command start', async () => {
      jest.spyOn(Service.prototype, Service.prototype.startStreamming.name).mockResolvedValue()
